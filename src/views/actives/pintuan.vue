    ...
    <div class="wrap">
        <div class="top_info">
            ...
            <el-button-group class="btn_wrap">
                <el-button type="primary" @click="toAdd">新建拼团项</el-button>
            </el-button-group>
        </div>
         ...
         <el-table :data="list" :header-cell-style="{'color':'#333', 'background-color':'#f5f5f5'}">
            ...
            <el-table-column prop="status" fit label="拼团可售状态">
                <template slot-scope="scope">
...
<script>
const api = require("@/api/group_purchase");
export default {
    data() {
        return {
            list:[],
    ...
    methods: {
        ...
        toAdd() {
            this.$router.push({
                path: "/actives/group_purchase/operate"
            })
        },
        editItem(id) {
            this.$router.push({
