                ...
                <el-table :data="orders" border :header-cell-style="{'color':'#333', 'background-color':'#f5f5f5'}">
                    ...
                    <el-table-column label="消费" fixed="right" width="150">
                        <template slot-scope="scope">
                            ...
                            <span v-else-if="scope.row.cost_type == 2">年卡</span>
                            <span v-else-if="scope.row.cost_type == 3">季卡</span>
                            <span v-else-if="scope.row.cost_type == 4">月卡</span>
                            <span v-else-if="scope.row.cost_type == 5">周卡</span>
                        </template>
                    </el-table-column>
                    <!-- 
