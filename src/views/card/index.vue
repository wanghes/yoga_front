    ...
    <div class="wrap">
        <div class="top_info">
            <div class="left_search">
                ...
                <el-input class="input_search" placeholder="请填写卡种名称" clearable @keyup.enter.native="nameChange" @clear="nameChange" v-model="searchForm.name">
        ...
        <div style="text-align: center; margin: 30px 0;">
            <el-pagination background layout="total, sizes, prev, pager, next, jumper" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage" :page-sizes="[15, 30, 50]" :page-size="pageSize" :total="total">
            </el-pagination>
        </div>
...
export default {
	...
	methods: {
		async fetchData() {
			let { name, type, status } = this.searchForm;
