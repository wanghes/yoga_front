<template>
    <el-card class="box-card">
        <div slot="header" class="clearfix">
            <span>统计数据：会员总共预约 2 次。</span>
        </div>
        <el-table :data="list" border :header-cell-style="{'color':'#333', 'background-color':'#f5f5f5'}">
            <el-table-column width="200" label="卡号">
                <span>{{card}}</span>
            </el-table-column>  
            <el-table-column prop="card_name" width="200" label="用户名">
            </el-table-column>  
            <el-table-column prop="course_name"  width="100" label=课程>
            </el-table-column>
            <el-table-column prop="course_name"  width="100" label="课程时间">
            </el-table-column>  
            <el-table-column prop="course_name"  width="100" label="预约时间">
            </el-table-column>   
            <el-table-column prop="course_name"  width="100" label="状态">
            </el-table-column>
            <el-table-column prop="course_name"  width="100" label="备注">
            </el-table-column>   
