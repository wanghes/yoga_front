<template>
    <el-card class="box-card">
        ...
        <el-table :data="list" border :header-cell-style="{'color':'#333', 'background-color':'#f5f5f5'}">
            ...
            <el-table-column prop="card_name" width="200" label="预约的项目">
            </el-table-column>  
            <el-table-column prop="course_name"  width="fit" label="老师">
            </el-table-column> 
            <el-table-column prop="course_name"  width="fit" label="课程时间">
            </el-table-column>  
            <el-table-column prop="course_name"  width="fit" label="预约状态">
            </el-table-column>  
            <el-table-column prop="remark"  width="fit" label="操作员">
            </el-table-column> 
            <el-table-column prop="remark"  width="fit" label="操作">
            </el-table-column>  
        </el-table>
    </el-card>
