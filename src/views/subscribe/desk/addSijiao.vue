<template>
    <el-form :model="addForm" label-position="top">
        <el-form-item required label="选择上课日期">
            <el-date-picker v-model="addForm.date" placeholder="选择上课日期">
            </el-date-picker>
        </el-form-item>

        <el-form-item required label="开始和结束时间点设置">
            <el-time-select placeholder="起始时间" v-model="addForm.start_time" :picker-options="{
                    start: '08:30',
                    step: '00:30',
                    end: '20:00'
                }">
            </el-time-select>
            <el-time-select placeholder="结束时间" v-model="addForm.end_time" :picker-options="{
                    start: '08:30',
                    step: '00:30',
                    end: '20:00',
        ...
        <el-form-item label="备注说明">
            <el-input type="textarea" placeholder="请输备注说明" v-model="addForm.des" maxlength="150" show-word-limit>
            </el-input>
        </el-form-item>
        <el-form-item>
