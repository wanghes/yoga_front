    ...
    <div class="wrap">
        <div class="main_box">
            <el-row :gutter="15" class="search_box">
                ...
                <el-col :span="4">
                    <el-date-picker style="width:100%" v-model="form.apply_time" type="date" placeholder="选择日期">
                    </el-date-picker>
                </el-col>
                <el-col :span="2">
        ...
        <el-dialog title="审核体验课" width="30%" :visible.sync="visible">
            ...
            <br />
            <br />
            <el-input v-if="radio==2" type="textarea" placeholder="请输驳回入内容" v-model="textarea" maxlength="100" show-word-limit></el-input>
            <br />
            <br />
...
export default {
	...
	methods: {
		async fetchData() {
			let { pay_status, username, status, phone, apply_time } = this.form;
